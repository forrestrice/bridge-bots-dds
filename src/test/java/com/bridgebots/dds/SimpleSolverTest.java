...
class SimpleSolverTest {
    ...
    void testThreeCardsWithFinesseAndRuff() {
        SimpleSolver solver = new SimpleSolver();
        //finesse onside
        Hand northHand = new ListHand("A Q", "2", "", "");
        Hand southHand = new ListHand("4 3 2", "", "", "");
        Hand eastHand = new ListHand("", "A K Q", "", "");
        Hand westHand = new ListHand("K 5", "7", "", "");
    ...
    void testFullHand(){
        SimpleSolver solver = new SimpleSolver();
        Hand northHand = new ListHand("A 5", "K Q J 10 4 3", "Q J 8", "6 4");
        Hand southHand = new ListHand("9 2", "8 5", "K 10 6", "A K J 8 7 3");
        Hand eastHand = new ListHand("Q J 8 6 4 3", "2", "A 5 3", "Q 10 5");
        Hand westHand = new ListHand("K 10 7", "A 9 7 6", "9 7 4 2", "9 2");
    ...
    void testEightCards(){
        SimpleSolver solver = new SimpleSolver();
        Hand northHand = new ListHand("", "", "A K 6 5 4", "A 10 7");
        Hand southHand = new ListHand("", "A K Q J 10 9 8", "", "2");
        Hand eastHand = new ListHand("3 2", "", "Q J 10 9 8", "K");
        Hand westHand = new ListHand("A K Q", "4 3 2", "2", "3");
