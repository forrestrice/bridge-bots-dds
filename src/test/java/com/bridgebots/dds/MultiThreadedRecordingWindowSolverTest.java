...
public class MultiThreadedRecordingWindowSolverTest {
    @Test
    void testFiveCards(){
        MultiThreadedRecordingWindowSolver solver = new MultiThreadedRecordingWindowSolver();
    ...
    void testSevenCardsBitSetHandsWithRestriction(){
        RecordingWindowSolver recordingWindowSolver = new RecordingWindowSolver(Board::restrictedNextPlays);


        MultiThreadedRecordingWindowSolver solver = new MultiThreadedRecordingWindowSolver(Board::restrictedNextPlays);
    ...
    void testTenCardsBitSetHandsWithRestriction(){
        ...
        MultiThreadedRecordingWindowSolver recordingWindowSolver = new MultiThreadedRecordingWindowSolver();
